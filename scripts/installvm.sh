...
install_apt_deps() {
  apt-get install --yes fswatch jq rsync curl git gettext-base python3 gnupg
}

install_avahi() {
  apt-get install --yes avahi-daemon avahi-discover libnss-mdns
}
...
install_docker_compose() {
  apt-get install --yes python3-pip libffi-dev
...
# UMBREL_REPO="https://github.com/baronrustamov/noosphere .git"
